...
<?
	...
	$this->Js->event(
	    'change',
	    $this->Js->request(
	        array('action' => 'fetchEmployeesWithAccount', 'controller'=>'employees'),
	        array(
	        'async' => true, 
	        'update' => '#EmployeeId',
	        'dataExpression' => true, 
...
<?php echo $this->Form->create('Transaction'); ?>
	...
	<div class="input select">
		<label for="UnionId">Choose Union :</label>
		<select name="Union" id="UnionId">
			<option>Choose a Union</option>
		</select>
	</div>
	<div class="input select">
		<label for="EmployeeId">Choose Employee :</label>
		<select name="data[Transaction][account_id]" id="EmployeeId">
