...
<?php echo $this->Form->create('Transaction'); ?>
	<fieldset>
		<? $upazillaName = $upazillas['Upazilla']['name']; ?>
		<legend><?php echo __("Transfer Money To $upazillaName"); ?></legend>
	<?php
		...
		echo $this->Form->input('upazilla_id',array('type'=>'hidden','value'=>$upazillas['Upazilla']['id']));
	?>
	</fieldset>
