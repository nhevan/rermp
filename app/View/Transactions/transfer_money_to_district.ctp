...
<?
	...
	$this->Js->event(
	    'change',
	    $this->Js->request(
	        array('action' => 'fetchDistrictsWithAccounts', 'controller'=>'districts'),
	        array(
	        'async' => true, 
	        'update' => '#UpazillaDistrictAccountId',
	        'dataExpression' => true, 
            'method' => 'post', 
...
<?php echo $this->Form->create('Transaction'); ?>
	<fieldset>
		<legend><?php echo __('Transfer Money To District Account'); ?></legend>
	...
	<div class="input select">
		<label for="UpazillaDistrictAccountId">Choose District :</label>
		<select name="data[Transaction][account_id]" id="UpazillaDistrictAccountId">
