...
<?php echo $this->Form->create('Awareness'); ?>
	<fieldset>
		<legend><?php echo __('Edit Awareness'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Awareness.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Awareness.id'))); ?></li>
