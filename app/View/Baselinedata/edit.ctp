...
<?php echo $this->Form->create('Baselinedatum'); ?>
	<fieldset>
		<legend><?php echo __('Edit Baselinedatum'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Baselinedatum.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Baselinedatum.id'))); ?></li>
